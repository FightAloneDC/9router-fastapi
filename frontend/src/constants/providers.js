...
export const APIKEY_PROVIDERS = {
  ...
  "kilo-gateway": { id: "kilo-gateway", alias: "kg", name: "Kilo Gateway", icon: "Code", color: "#FF6B35", textIcon: "KG", website: "https://kilo.ai", notice: { apiKeyUrl: "https://kilo.ai" }, serviceKinds: ["llm"] },
