"""backfill nvidia models into provider_models

Revision ID: b1c2d3e4f5a6
Revises: 9b1ea472199b
...
down_revision: Union[str, Sequence[str], None] = "9b1ea472199b"
...
def downgrade() -> None:
    op.execute(sa.text(
        "DELETE FROM provider_models WHERE provider = 'nvidia'"
    ))
