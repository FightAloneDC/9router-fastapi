"""Stability AI model fetching.

Fetches available models from Stability AI API.
"""
...
async def fetch_models(api_key: str) -> list[dict]:
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Stability AI.
