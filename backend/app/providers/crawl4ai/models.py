"""Crawl4AI model fetching.

Fetches available models from Crawl4AI API.
"""
...
def parse_response(data: dict) -> list:
    """Extract models list from Crawl4AI API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Crawl4AI.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Crawl4AI.
