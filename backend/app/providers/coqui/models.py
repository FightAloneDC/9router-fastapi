"""Coqui TTS model fetching.

Fetches available models from Coqui TTS API.
"""
...
def parse_response(data: dict) -> list:
    """Extract models list from Coqui TTS API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Coqui TTS.

    Args:
        api_key: Coqui TTS API key.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Coqui TTS.
