"""Blackbox AI model fetching.

Fetches available models from Blackbox AI API.
"""

import httpx

from app.providers.blackbox.config import BlackboxConfig
from app.utils.url import url_path_join

_config = BlackboxConfig()
...
def parse_response(data: dict) -> list:
    """Extract models list from Blackbox AI API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Blackbox AI.

    Args:
        api_key: Blackbox AI API key.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Blackbox AI.
