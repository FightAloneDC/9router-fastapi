"""Minimax Coding model fetching.

Fetches available models from Minimax Coding API.
"""
...
async def fetch_models(api_key: str) -> list[dict]:
    ...
    Args:
        api_key: Minimax Coding API key.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Minimax Coding.
