"""Azure OpenAI model fetching.

Fetches available models from Azure OpenAI API.
"""
...
def parse_response(data: dict) -> list:
    """Extract models list from Azure OpenAI API response."""
...
async def fetch_models(api_key: str) -> list[dict]:
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Azure OpenAI.
