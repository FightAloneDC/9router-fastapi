"""Local Device model fetching.

Fetches available models from Local Device API.
"""
...
def parse_response(data: dict) -> list:
    """Extract models list from Local Device API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Local Device.

    Args:
        api_key: Local Device API key.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Local Device.
