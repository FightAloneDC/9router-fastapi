"""Voyage AI model fetching.

Fetches available models from Voyage AI API.
"""
...
def parse_response(data: dict) -> list:
    """Extract models list from Voyage AI API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Voyage AI.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Voyage AI.
