"""Stable Diffusion WebUI model fetching.

Fetches available models from Stable Diffusion WebUI API.
"""
...
def parse_response(data: dict) -> list:
    """Extract models list from Stable Diffusion WebUI API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Stable Diffusion WebUI.

    Args:
        api_key: Stable Diffusion WebUI API key.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Stable Diffusion WebUI.
