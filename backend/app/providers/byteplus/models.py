"""BytePlus ModelArk model fetching.

Fetches available models from BytePlus ModelArk API.
"""
...
async def fetch_models(api_key: str) -> list[dict]:
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to BytePlus ModelArk.
