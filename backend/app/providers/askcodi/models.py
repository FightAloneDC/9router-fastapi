"""AskCodi model fetching.

Fetches available models from AskCodi API.
"""
...
async def fetch_models(api_key: str) -> list[dict]:
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to AskCodi.
