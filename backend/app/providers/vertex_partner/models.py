"""Vertex Partner model fetching.

Fetches available models from Vertex Partner API.
"""
...
async def fetch_models(api_key: str) -> list[dict]:
    ...
    Args:
        api_key: Vertex Partner API key.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Vertex Partner.
