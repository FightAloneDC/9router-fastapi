"""Linkup model fetching.

Fetches available models from Linkup API.
"""

import httpx

from app.providers.linkup.config import LinkupConfig
...
def parse_response(data: dict) -> list:
    """Extract models list from Linkup API response."""
    return data.get("data", [])


async def fetch_models(api_key: str) -> list[dict]:
    """Fetch available models from Linkup.
    ...
    Raises:
        ...
        httpx.ConnectError: If cannot connect to Linkup.
